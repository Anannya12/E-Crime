...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2022 at 06:10 PM
...
INSERT INTO `cases` (`employee_id`, `name`, `severity`, `case_num`, `notes`) VALUES
(1029482, 'arnold', 'Normal', 2147483647, '<p>testtt</p>'),
(1038492, 'arnold', 'Normal', 2147483647, '<p>sdsd</p>'),
(1938203, 'arnold', 'Normal', 2147483647, '<p>&nbsp;</p>'),
(1938204, 'arnold', 'Normal', 2147483647, '<p>afaf</p>');
...
(1, 'Ashik', 'ahamed', 'ashik@gmail.com', 'ashik', '827ccb0eea8a706c4c34a16891f84e7b', '08 April 2022', 'user', '1', 'M', '01111111111');
...
--
ALTER TABLE `cases`
  MODIFY `employee_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1938205;
