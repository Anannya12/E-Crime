    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content" class="col-md-12">
                ...
                $sql = "INSERT INTO employees(name,description,email,joined,gender,phone,tmp,employee_id)VALUES('$name','$description','$email','$joined','$gender','$phone','$tmp','$employee_id')";
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Description</label>
              <input type="text" class="form-control" name="description" pattern="[A-Za-z]{3,}" required>
            </div>  
        </div>
            <div class="row form-group">
          <div class="col-lg-6">
