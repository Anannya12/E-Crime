        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                if(isset($mysqli,$_POST['update'])){
                    ...
                    $sqlTaru = "UPDATE users SET name ='$name', description ='$description', phone ='$phone', email ='$email' WHERE username= '{$_SESSION['username']}'";
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Description</label>
              <input type="text" class="form-control" name="description" pattern="[A-Za-z]{3,}" value="<?php echo $eprow['description'];?>" required>
            </div>  
        </div>
            <div class="row form-group">
          <div class="col-lg-6">
